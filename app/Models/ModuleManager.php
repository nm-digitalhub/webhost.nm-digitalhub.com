 ...
 *
 * It doesn't actually use a database table, but instead proxies requests to the ModuleScanner.
 * However, it implements enough of Eloquent's interface to work with Filament Resources.
 *
 ...
 * 5. Never use static calls to `Builder` class - always use `(new static)->newQuery()` pattern.
 *
