        ...
        <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg">
            ...
            @if ($emailSentMessage)
                <div class="mb-4 font-medium text-sm text-green-600">
                    {{ __('A new password reset link has been sent to your email address.') }}
                </div>
            @endif
            ...
            <form wire:submit="sendResetPasswordLink">
                <div>
                    ...
                    <input id="email" type="email" wire:model="email" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" autofocus>
